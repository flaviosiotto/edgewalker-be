...
CUSTOM_INDICATORS = {
    ...
    "volume_profile": {
        ...
        "parameters": {
            ...
            "row_size": {"type": "number", "default": 0, "min": 0,
                         "description": "Price height of one row (0 = auto from instrument scale)"},
            "bins": {"type": "integer", "default": 0, "min": 0, "max": 500,
                     "description": "Aggregate to N rows (0 = one row per price step)"},
